...
Patch9:		tigervnc11-rh632530.patch
Patch10:	tigervnc11-rh645755.patch
Patch12:	tigervnc11-rh588342.patch
Patch13:	tigervnc11-rh690245.patch
...
%patch9 -p1 -b .rh632530
%patch10 -p1 -b .rh645755
...
# workaround missing file breaking build
touch man/Xserver.man
popd

%patch12 -p1 -b .rh588342
%patch13 -p1 -b .rh690245
%patch14 -p1 -b .ldnow
...
* Wed Nov 14 2012 Adam Tkac <atkac redhat com> 1.1.0-4
- allow to change AcceptPointerEvents via vncconfig

* Mon Oct 22 2012 Adam Tkac <atkac redhat com> 1.1.0-3
- initscript: print msg when vnc password is not configured

* Wed Sep 26 2012 Dave Airlie <airlied@redhat.com> 1.1.0-2
- rebuild against 1.13.0 due to ABI issues

* Thu Aug 09 2012 Dave Airlie <airlied@redhat.com> 1.1.0-1
- import from F18 for 1.13.0 server

* Wed Nov 09 2011 Dave Airlie <airlied@redhat.com> 1.0.90-0.17.20110314svn4359
- rebuild for X server 1.10.4 (#752471)

* Tue May 10 2011 Adam Tkac <atkac redhat com> 1.0.90-0.16.20110314svn4359
- viewer can send password without proper validation of X.509 certs
  (CVE-2011-1775)

* Thu Mar 31 2011 Adam Tkac <atkac redhat com> 1.0.90-0.15.20110314svn4359
- flush internal Xvnc event queue early to avoid overflowing
- improve compatibility with viewers with wrong VeNCrypt implementation
  (vinagre)
- link libvnc.so with "-z now" to catch all undefined symbols
- fix undefined symbol "getvnchomedir" in libvnc.so

* Fri Mar 18 2011 Adam Tkac <atkac redhat com> 1.0.90-0.14.20110314svn4359
- improve fix for keyboards with no mods (#628054)

* Tue Mar 15 2011 Adam Tkac <atkac redhat com> 1.0.90-0.13.20110314svn4359
- update to r4359 (TLS fixes, build fixes)

* Mon Jan 17 2011 Adam Tkac <atkac redhat com> 1.0.90-0.12.20110117svn4237
- tigervnc-server now requires perl (#634161)
- use locales specified in sysconfig/i18n (#632530)
- read password file correctly when fread is interrupted (#645755)

* Mon Jan 17 2011 Adam Tkac <atkac redhat com> 1.0.90-0.11.20110117svn4237
- rebase to r4237
- patches merged
  - tigervnc11-noexecstack.patch
  - tigervnc11-r3963.patch
  - tigervnc11-r4002.patch
  - tigervnc11-r4014.patch
  - tigervnc11-r4003.patch
  - tigervnc11-r4004.patch
  - tigervnc11-r4005.patch
  - tigervnc11-r4024.patch
  - tigervnc11-r4025.patch
  - tigervnc11-rh603731.patch
